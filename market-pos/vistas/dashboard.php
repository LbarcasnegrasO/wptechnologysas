         ...
         <div class="col-12">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title" id="header-title">Ventas del Mes: $ 800,000.00</h3>
                ...
                <div class="card-body">
                    <div class="chart">
                        <canvas id="barchard" style="min-height: 250px; height: 300px; max-height: 350px; width: 100%;">
...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            success:function(respuesta){
                ...
                $("#totalGanancias").html('$' + respuesta[0]['ganancias'].replace(/\d(?=(\d{3})+\.)/g, "$&,"));
                $("#totalProductosMinStock").html(respuesta[0]['productosPocoStock']);
                $("#totalVentasHoy").html('$' + respuesta[0]['ventasHoy'].replace(/\d(?=(\d{3})+\.)/g, "$&,"));
            }
        });
    ...
    $.ajax({
        ...
        console.log("respuesta",respuesta);
            ...
            $("#header-title").html('ventas del mes: $ ' + total_ventas_mes.toString().replace(/\d(?=(\d{3})+\.)/g, "$&,"));

            var barChartCanvas = $("#barchard").get(0).getContext('2d');
            var areaChartData = {
                labels: fecha_venta,
                datasets:[
                    {
            ...
            var barCharData = $.extend(true, {}, areaChartData);

            var temp0 = areaChartData.datasets[0];

            barCharData.datasets[0] = temp0;
