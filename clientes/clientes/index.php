...
$servidor = "localhost"; $usuario = "root"; $contrasenia = "123456"; $nombreBaseDatos = "clientes";
...
if(isset($_GET["insertar"])){
    ...
    $sqlClientes = mysqli_query($conexionBD,"INSERT INTO campañaCRM(nombres,direcciones) VALUES('$nombre','$correo') ");
    echo json_encode(["success"=>1]);
        }
    exit();
}
